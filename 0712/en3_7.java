...
class PhysExamSearch {
    ...
    static class PhyscData {
        ...
        //            }
        //---視力昇順用コンパレータ ---//
        public static final Comparator<PhyscData> VISHON_ORDER =
            new VishonOrderComparator();

        private static class VishonOrderComparator
                implements Comparator<PhyscData> {
                public int compare(PhyscData d1, PhyscData d2) {
    ...
    public static void main(String[] args) {
        ...
        PhyscData[] x = {					// 配列の要素は身長順でなければならない
            ...
            new PhyscData("加藤富明", 173, 1.7),
            new PhyscData("浜田哲明", 174, 1.8),
        ...
        //}
        System.out.print("どのくらいの視力の人を探しますか：");
        double vision = stdIn.nextDouble();				// キー値の読込み
        int idx = Arrays.binarySearch(
                x,											// 配列xから
                new PhyscData("", 0, vision),	// 身長がvisionの要素を
                PhyscData.VISHON_ORDER // VISHON_ORDERによって探索
                );
